...
const sampleCertManager = `apiVersion: certificates.platform.tbd.io/v1alpha1
kind: CertManager
metadata:
...
const sampleCertManagerRequired = `apiVersion: certificates.platform.tbd.io/v1alpha1
kind: CertManager
metadata:
  name: certmanager-sample
spec:
