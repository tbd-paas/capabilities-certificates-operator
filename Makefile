...
docker-buildx: test ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name capabilities-certificates-operator-builder
	$(CONTAINER_TOOL) buildx use capabilities-certificates-operator-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm capabilities-certificates-operator-builder
	rm Dockerfile.cross
...
build-cli: ## Build the companion CLI.
	go build -o bin/certificatesctl cmd/certificatesctl/main.go
