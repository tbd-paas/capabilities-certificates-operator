...
// CertificatesCapabilityReconciler reconciles a CertificatesCapability object.
type CertificatesCapabilityReconciler struct {
	client.Client
	Name         string
	Log          logr.Logger
...
func NewCertificatesCapabilityReconciler(mgr ctrl.Manager) *CertificatesCapabilityReconciler {
	return &CertificatesCapabilityReconciler{
		Name:         "CertificatesCapability",
		Client:       mgr.GetClient(),
		Events:       mgr.GetEventRecorderFor("CertificatesCapability-Controller"),
		FieldManager: "CertificatesCapability-reconciler",
...
func (r *CertificatesCapabilityReconciler) Reconcile(ctx context.Context, request ctrl.Request) (ctrl.Result, error) {
...
func (r *CertificatesCapabilityReconciler) NewRequest(ctx context.Context, request ctrl.Request) (*workload.Request, error) {
	component := &capabilitiesv1alpha1.CertificatesCapability{}
...
func (r *CertificatesCapabilityReconciler) GetResources(req *workload.Request) ([]client.Object, error) {
	component, err := capabilitiescertificates.ConvertWorkload(req.Workload)
	if err != nil {
		return nil, err
	}

	return capabilitiescertificates.Generate(*component, r, req)
}

// GetEventRecorder returns the event recorder for writing kubernetes events.
func (r *CertificatesCapabilityReconciler) GetEventRecorder() record.EventRecorder {
	return r.Events
}

// GetFieldManager returns the name of the field manager for the controller.
func (r *CertificatesCapabilityReconciler) GetFieldManager() string {
	return r.FieldManager
}

// GetLogger returns the logger from the reconciler.
func (r *CertificatesCapabilityReconciler) GetLogger() logr.Logger {
	return r.Log
}

// GetName returns the name of the reconciler.
func (r *CertificatesCapabilityReconciler) GetName() string {
	return r.Name
}
...
func (r *CertificatesCapabilityReconciler) GetWatches() []client.Object {
	return r.Watches
}

// SetWatch appends a watch to the list of currently watched objects.
func (r *CertificatesCapabilityReconciler) SetWatch(watch client.Object) {
	r.Watches = append(r.Watches, watch)
}

// CheckReady will return whether a component is ready.
func (r *CertificatesCapabilityReconciler) CheckReady(req *workload.Request) (bool, error) {
	return dependencies.CertificatesCapabilityCheckReady(r, req)
}
...
func (r *CertificatesCapabilityReconciler) Mutate(
	req *workload.Request,
	object client.Object,
) ([]client.Object, bool, error) {
	return mutate.CertificatesCapabilityMutate(r, req, object)
}

func (r *CertificatesCapabilityReconciler) SetupWithManager(mgr ctrl.Manager) error {
	r.InitializePhases()

	baseController, err := ctrl.NewControllerManagedBy(mgr).
		WithEventFilter(predicates.WorkloadPredicates()).
		For(&capabilitiesv1alpha1.CertificatesCapability{}).
		Build(r)
	if err != nil {
