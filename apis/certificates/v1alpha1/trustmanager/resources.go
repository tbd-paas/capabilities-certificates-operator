...
const sampleTrustManager = `apiVersion: certificates.platform.tbd.io/v1alpha1
kind: TrustManager
metadata:
...
const sampleTrustManagerRequired = `apiVersion: certificates.platform.tbd.io/v1alpha1
kind: TrustManager
metadata:
  name: trustmanager-sample
spec:
