...
// CertificatesCapabilityGroupVersions returns all group version objects associated with this kind.
func CertificatesCapabilityGroupVersions() []schema.GroupVersion {
